  ...
  return (
    <components.Option {...props}>
      <label
        ...
        data-testid={`location-option-${data.value.replace(/\s+/g, "-").toLowerCase()}`}
      >
        {label}
      </label>
    </components.Option>
...
const Filter: React.FC<FilterProps> = ({ onFilterChange }) => {
  ...
  return (
    ...
    >
      ...
      >
        <svg viewBox="0 0 512 512" className="h-4 fill-white transition-all" aria-hidden="true">
      ...
      {showSelect && (
        <div
          className="absolute top-14 right-0 w-[300px] sm:w-[360px] bg-white shadow-lg border rounded z-10"
