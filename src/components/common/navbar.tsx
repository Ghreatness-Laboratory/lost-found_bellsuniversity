...
const Navbar: React.FC<NavbarProps> = ({ isNavbarOpen, handleNavClick }) => {
  ...
  return (
    <nav
      ...
      className="py-3 sm:py-5 px-4 md:px-10 bg-white"
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-1">
          ...
          <img
            ...
            aria-required
          />
          <p className="hidden sm:block font-bold text-xl lg:text-2xl text-center lg:pl-[19px] lg:pr-[29px]">
            MisplaceMe
          </p>
        </div>
            ...
            {navbarMenu.map((menu, index) => {
              ...
              return (
                <Link
                  ...
                  className={`py-2 font-normal text-base cursor-pointer border-b-2 border-b-white hover:border-b-2 hover:border-b-blue-600 hover:text-blue-600 transition ease duration-200ms ${
            ...
            <nav className="fixed bottom-0 top-0 right-0 bg-white z-20 w-[305px] flex flex-col justify-between py-8 pt-8 md:pt-12">
              <div>
                ...
                >
                  ``
                  <svg
                    className="absolute right-4 md:right-8 top-5 md:top-12"
                  ...
                  {navbarMenu.map((menu, index) => {
                    ...
                    return (
                      <Link
                        ...
                        to={menu.href}
                        onClick={handleNavClick}
                        className={`py-1 md:py-2 pl-8 font-normal text-base cursor-pointer border-l-2 border-l-white md:border-b-2 md:border-b-white active:border-l-blue-600 md:hover:border-b-blue-600 active:text-blue-600 md:hover:text-blue-600 transition ease duration-200ms ${
                          isActive ? isMenuActive : ""
                        }`}
                      >
                        {menu.menu}
            ...
            location.pathname === "/make-a-report" ? (
              <Link to={"/"}>
                <button
                  ...
                  className="hidden sm:flex items-center gap-1.5 justify-center cursor-pointer rounded-lg p-2 bg-[rgba(129,129,129,0.06)] backdrop-blur-[2px]"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18"
                  ...
                  >
                    <path
                      d="M1.0835 9.00004C1.0835 5.26837 1.0835 3.40171 2.24266 2.24254C3.40183 1.08337 5.26766 1.08337 9.00016 1.08337C12.7318 1.08337 14.5985 1.08337 15.7577 2.24254C16.9168 3.40171 16.9168 5.26754 16.9168 9.00004C16.9168 12.7317 16.9168 14.5984 15.7577 15.7575C14.5985 16.9167 12.7327 16.9167 9.00016 16.9167C5.2685 16.9167 3.40183 16.9167 2.24266 15.7575C1.0835 14.5984 1.0835 12.7325 1.0835 9.00004Z"
                      stroke="#1E1E1E"
                      strokeWidth="1.25"
                      strokeLinecap="round"
                    ...
                    />
                    <path
                      d="M13.1976 9.02343H7.38509M7.38509 9.02343C7.38509 9.49843 9.18092 11.0959 9.18092 11.0959M7.38509 9.02343C7.38509 8.5351 9.18092 6.96926 9.18092 6.96926M4.86426 5.6626V12.3293"
                      stroke="#1E1E1E"
                      strokeWidth="1.25"
                      strokeLinecap="round"
                      strokeLinejoin="round"
