...
const ReportsHistory: React.FC = () => {
  ...
  return (
    <section className="sm:px-4 mx-auto">
      <div className="relative mb-4 md:px-4 lg:px-0 w-full md:max-w-xl">
        <input
          type="text"
          ...
          className="w-full pl-12 py-2 border-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
