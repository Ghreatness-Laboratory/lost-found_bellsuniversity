  ...
  return (
    <section>
      <div className="relative mb-4 lg:px-0 w-full md:max-w-xl">
        ...
        />
        <FaSearch className="absolute top-1/2 left-5 -translate-y-1/2" color="gray" />
      </div>
              ...
              <table className="w-full min-w-[800px] divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th scope="col" className="px-12 py-3.5 text-sm font-normal flex sm:block justify-center text-gray-500">
                      <button className="flex items-center gap-x-2">
                        <span>Date</span>
                        <FaClock />
                      </button>
                    </th>
                    <th scope="col" className="px-10 py-3.5 text-sm font-normal text-left text-gray-500">
                      <button className="flex items-center gap-x-2">
                        <span>Location</span>
                    ...
                    <th scope="col" className="relative py-3.5 px-4 text-sm font-normal text-gray-500 text-left">
