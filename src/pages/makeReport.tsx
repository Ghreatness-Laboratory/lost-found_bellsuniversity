...
function MakeAReport() {
  ...
  return (
    <div className="flex px-4 md:px-10 my-10">
      <section className="relative flex flex-col lg:flex-row gap-8 md:gap-10 w-full">
        <div className="max-w-3xl w-full">
          <h1 className="text-lg sm:text-xl md:text-2xl font-semibold text-center mb-4">Fill the form to make a report</h1>
          <ReportForm
        ...
        <div className='lg:absolute lg:right-0 lg:top-0 px-4 py-4 lg:pt-10 lg:max-w-md w-full h-full bg-gray-100'>
          <span className="sr-only">Report Preview</span>
          <div className="flex flex-col gap-2 md:gap-3 ">
            <img
              src={LostImage}
              alt="Lost and Found Item"
              className={`object-cover w-full h-[180px] md:h-[200px] rounded-md`}
            />

            <div className='flex flex-col items-center gap-1 md:gap-2'>
              <h3>Wristwatch found in the classroom</h3>
              <div className='flex items-center gap-2'>
                ...
                <p className='text-center'>13/12/24</p>
              </div>
            </div>
          </div>
        </div>
