            ...
            <div className="p-6 space-y-4">
              <div className="text-center">
                ...
                <div className='flex items-center justify-center gap-2 text-gray-600 mb-3'>
                  ...
                  <p className='text-sm'>13/12/24</p>
                </div>

                <p className="text-gray-600 text-sm leading-relaxed">
                  A wristwatch was found in the classroom during the afternoon session.
                  If you believe this item belongs to you, please contact the lost and found office.
                </p>
              </div>
